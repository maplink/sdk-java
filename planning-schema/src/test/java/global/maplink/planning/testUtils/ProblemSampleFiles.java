...
public enum ProblemSampleFiles implements TestFiles {
    ...
    COMPARTMENT2("planning.json/samples/problem/compartmentValidator.json"),
    ...
    PROBLEM2("planning.json/samples/problem/problemValidator.json"),
    PROBLEM_RESPONSE("planning.json/samples/problem/problemResponse.json"),
    PRODUCT("planning.json/samples/problem/product.json"),
    PRODUCT2("planning.json/samples/problem/productValidator.json"),
    ...
    VEHICLE2("planning.json/samples/problem/vehicleValidator.json"),
