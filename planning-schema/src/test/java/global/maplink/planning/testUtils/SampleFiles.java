...
public enum SampleFiles implements TestFiles {
    ...
    COMPARTMENT_SOLUTION("planning.json/samples/problem/compartmentSolution.json"),
    COMPARTMENT_SOLUTION_GROUP("planning.json/samples/problem/compartmentSolutionGroup.json"),
    ...
    ROUTE("planning.json/samples/problem/route.json"),
    ...
    VIOLATION_CONSTRAINT("planning.json/samples/problem/violationConstraint.json");
